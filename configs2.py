...
def m9(n):
    ...
    n.layer1[0].conv1 = nn.Conv2d(64, 64, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer1[0].conv2 = nn.Conv2d(64, 64, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer1[1].conv1 = nn.Conv2d(64, 64, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer1[1].conv2 = nn.Conv2d(64, 64, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer1[2].conv1 = nn.Conv2d(64, 64, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer1[2].conv2 = nn.Conv2d(64, 64, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    
    n.layer2[0].conv1 = nn.Conv2d(64, 128, kernel_size=(11, 11), stride=(2, 2), padding=(5, 5), bias=False)
    n.layer2[0].conv2 = nn.Conv2d(128, 128, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer2[1].conv1 = nn.Conv2d(128, 128, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer2[1].conv2 = nn.Conv2d(128, 128, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer2[2].conv1 = nn.Conv2d(128, 128, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer2[2].conv2 = nn.Conv2d(128, 128, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer2[3].conv1 = nn.Conv2d(128, 128, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer2[3].conv2 = nn.Conv2d(128, 128, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    
    n.layer3[0].conv1 = nn.Conv2d(128, 256, kernel_size=(11, 11), stride=(2, 2), padding=(5, 5), bias=False)
    n.layer3[0].conv2 = nn.Conv2d(256, 256, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer3[1].conv1 = nn.Conv2d(256, 256, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer3[1].conv2 = nn.Conv2d(256, 256, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer3[2].conv1 = nn.Conv2d(256, 256, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer3[2].conv2 = nn.Conv2d(256, 256, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer3[3].conv1 = nn.Conv2d(256, 256, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer3[3].conv2 = nn.Conv2d(256, 256, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer3[4].conv1 = nn.Conv2d(256, 256, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer3[4].conv2 = nn.Conv2d(256, 256, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer3[5].conv1 = nn.Conv2d(256, 256, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer3[5].conv2 = nn.Conv2d(256, 256, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    
    n.layer4[0].conv1 = nn.Conv2d(256, 512, kernel_size=(11, 11), stride=(2, 2), padding=(5, 5), bias=False)
    n.layer4[0].conv2 = nn.Conv2d(512, 512, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer4[1].conv1 = nn.Conv2d(512, 512, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer4[1].conv2 = nn.Conv2d(512, 512, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer4[2].conv1 = nn.Conv2d(512, 512, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
    n.layer4[2].conv2 = nn.Conv2d(512, 512, kernel_size=(11, 11), stride=(1, 1), padding=(5, 5), bias=False)
...
configs = [
    # {"layer_function" : m1,
    # "save_path": '../freq_bias/models/Fairface_Multi_layer0_3_layerall_3_epoch_13_trial3.pt',
    # },
    # {"layer_function" : m2,
    # "save_path": '../freq_bias/models/UTKFace_Multi_layer0_3_layerall_7_epoch_13_trial1.pt',
    # },
    # {"layer_function" : m3,
    # "save_path": '../freq_bias/models/UTKFace_Multi_layer0_7_layerall_7_epoch_13_trial1.pt',
    # },
    # {"layer_function" : m4,
    # "save_path": '../freq_bias/models/Fairface_Multi_layer0_7_layerall_3_epoch_13_trial3.pt',
    # },
    # {"layer_function" : m5,
    # "save_path": '../freq_bias/models/Fairface_Multi_layer0_11_layerall_3_epoch_13_trial3.pt',
    # },
    # {"layer_function" : m6,
    # "save_path": '../freq_bias/models/UTKFace_Multi_layer0_11_layerall_7_epoch_13_trial1.pt',
    # },
    # {"layer_function" : m7,
    # "save_path": '../freq_bias/models/Fairface_Multi_layer0_13_layerall_3_epoch_13_trial3.pt',
    # },
    # {"layer_function" : m8,
    # "save_path": '../freq_bias/models/UTKFace_Multi_layer0_13_layerall_7_epoch_13_trial1.pt',
    # },
    {"layer_function" : m9,
    "save_path": '../freq_bias/models/Fairface_Multi_layer0_11_layerall_11_epoch_13_trial1.pt',
    },
]
